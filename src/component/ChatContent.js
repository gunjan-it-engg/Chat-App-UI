  ...
  return (
    <div style={{ display: "flex", flexWrap: "wrap" }}>
          ...
          <div style={{margin:"2px"}}>
            {response?.map((item)=>(
               ...
               alignItems: "center", display:"flex",
                margin:"5px"}}><div>{item.id}</div><div style={{marginLeft:"5px"}}><Button onClick={()=>props.chatstart(item.id)} variant="outlined"><ChatIcon/></Button></div></div>
            ))}
          </div>
        </CardContent>
      ...
      >
        ...
        <CardActions className={classes.buttom} style={{justifyContent: "center",
               alignItems: "center",
               display: "flex"}}><TextField style={{width:"600px"}} id="outlined-basic" label="Chat" variant="outlined" /><Button style={{width:"60px",height:"55px"}}variant="outlined"><SendIcon/></Button></CardActions>
      </Card>
      <Card
        className={classes.root}
        style={{
        ...
        <Typography
          ...
          <div style={{margin:"2px"}}>
            {room.map((item)=>(
               <div style={{justifyContent: "center",
               alignItems: "center",
               display: "flex", margin:"5px"}}><div>{item.title}</div><div style={{marginLeft:"5px"}}><Button variant="outlined"><ChatIcon/></Button></div></div>
            ))}
          </div>
        </CardContent>
        <CardActions></CardActions>
