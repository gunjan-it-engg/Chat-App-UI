...
function NavBar(props) {
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem onClick={handleMenuClose} component={Link} to="/chat">
        Chat
      </MenuItem>
      <MenuItem onClick={handlelogedout}>Log Out</MenuItem>
    </Menu>
  );
        ...
        <Toolbar>
          ...
          {props.authstate  ? (
            ...
            <div style={{ marginLeft: "auto", marginRight: "30px" }}>
              {!props.profileData?.role && props.authstate ? (
