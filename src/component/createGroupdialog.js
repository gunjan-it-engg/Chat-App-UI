...
import MyGroupForm from "./createGroupform";
    ...
    <div>
      ...
      >
        <DialogTitle id="form-dialog-title">
          <div style={{ fontWeight: "bold" }}>Create a Group</div>
        </DialogTitle>
        <DialogContent>
          <MyGroupForm />
        </DialogContent>
...
export default connect(mapStateToProps, mapDispatchToProps)(GroupDia);
